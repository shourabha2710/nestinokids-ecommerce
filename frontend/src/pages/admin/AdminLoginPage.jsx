    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gray-900 relative overflow-hidden">
        ...
        <div className="relative flex flex-col justify-center px-16">
          ...
          >
            <div className="w-14 h-14 rounded-xl bg-gold flex items-center justify-center mb-8">
              <span className="text-2xl font-bold text-gray-900">N</span>
            </div>
            <h1 className="text-4xl font-bold text-white mb-4">NestinoKids</h1>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gold/40 focus:border-gold transition-all text-sm"
                  autoComplete="email"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gold/40 focus:border-gold transition-all text-sm"
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center space-x-2 bg-gray-900 text-white py-2.5 rounded-xl font-semibold hover:bg-gray-800 disabled:opacity-60 disabled:cursor-not-allowed transition-all text-sm"
            >
              {loading ? (
