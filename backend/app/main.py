...
from app.api.v1.endpoints import promotions_public as promotions_public_router
...
from app.api.v1.endpoints import marketplace_analytics as marketplace_analytics_router
...
app.include_router(promotions_public_router.router)
...
app.include_router(marketplace_analytics_router.router)
